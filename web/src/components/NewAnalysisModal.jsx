...
import { Modal, Form, Select, Upload, Input, Radio, InputNumber, Switch, message, Tag, Row, Col, Collapse, Tooltip, Badge, Button } from 'antd';
...
const NewAnalysisModal = ({ open, onCancel, onSuccess }) => {
          ...
          <div className="border border-gray-200 rounded mb-4 bg-gray-50">
            <div className="p-4 border-b bg-white flex justify-between items-center">
              ...
              <div className="space-x-2">
                ...
                <Button size="small" type="link" onClick={() => window.location.href = '/code-library'}>
                  管理编码库 →
                </Button>
              </div>
            </div>
